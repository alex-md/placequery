var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) {return typeof obj;} : function (obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};var map;
var infowindow;
var searchBox;
var infowindow;
var list;
...
function initMap() {
	...
	// Default location
	var defaultLoc = { lat: 40.752239, lng: -73.9766287 };
...
function createPopup(list) {
	...
	$(list).each(function (index, value) {
		...
		section.style = "margin-bottom: 20px; padding-bottom: 10px; border-bottom: solid 1px #ccc;";
		...
		section.innerHTML += '<b>Phone Number:</b> ' + value.phone_number;
		;
...
function toCsvValue(theValue, sDelimiter) {
	var t = typeof theValue === 'undefined' ? 'undefined' : _typeof(theValue),output;
